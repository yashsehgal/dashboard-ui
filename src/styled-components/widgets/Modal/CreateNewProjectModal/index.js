    ...
    return (
        <div className="create-new-project-modal">
            ...
            <div className="create-new-project-details-form-wrapper">
                ...
                <div className="form-input-wrapper" id="project-github-repository-url-wrapper">
                    <h6 className="label-project-github-repository-url">Project's GitHub Repository URL</h6>
                    <Input type="text" 
                ...
                <div className="form-input-wrapper" id="project-tech-stack-wrapper">
                    <h6 className="label-project-tech-stack">Add tags related to your project tech-stack</h6>
                    <Input type="text" 
